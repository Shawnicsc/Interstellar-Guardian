		...
		<a-row type="flex">
			<a-col :span="24" :md="12">
				...
				<p class="copyright">
					...
					by <a href="https://blog-shawni.top">Shawn i</a> with love.
				</p>
				<!-- / Footer Copyright Notice -->
			...
			<a-col :span="24" :md="12" class="footer-control">
				...
				<a-menu mode="horizontal">
					<a-menu-item>
            <a href="https://blog-shawni.top/about/">About us</a>
          </a-menu-item>
					<a-menu-item>
            <a href="https://github.com/Shawnicsc/Interstellar-Guardian">Blog</a>
          </a-menu-item>
