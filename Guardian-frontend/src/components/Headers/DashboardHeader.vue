<template>
	...
	<component :is="navbarFixed ? 'a-affix' : 'div'" :offset-top="top">
		...
		<a-layout-header>
          ...
          <a-button class="btn-sign-in" v-on:click="handleLogout">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span style="color: firebrick">登出</span>
          </a-button>
					<!-- / Header Control Buttons -->

          <!-- Header Search Input -->
          <a-input-search class="header-search" :class="searchLoading ? 'loading' : ''" placeholder="请输入关键词" @search="onSearch" :loading='searchLoading'>
