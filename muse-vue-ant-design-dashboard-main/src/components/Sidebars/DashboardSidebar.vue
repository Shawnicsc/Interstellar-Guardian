<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-size.jpg" alt=""> <span>北京邮电大学</span></div>
			<hr>
        ...
        <a-menu-item>
          <router-link to="/crypto">
            ...
            <span class="label">字符串加密</span>
          </router-link>
        </a-menu-item>
				<a-menu-item>
					<router-link to="/ipfsService">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class="label">IPFS文件业务</span>
					</router-link>
				</a-menu-item>
        <a-menu-item>
